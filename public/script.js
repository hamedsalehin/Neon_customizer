...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ============================================================
    const FONT_LIST = [
        { name: 'a little sunshine',   file: 'a-little-sunshine.ttf' },
        { name: 'adventure Island Script', file: 'adventure-island-script.ttf' },
        { name: 'Andolucia',           file: 'andolucia.ttf' },
        { name: 'Anthony Houston',     file: 'anthony-houston.ttf' },
        { name: 'Balmonde',            file: 'balmonde.ttf' },
        { name: 'Baychore',            file: 'baychore.ttf' },
        { name: 'Bearline',            file: 'bearline.ttf' },
        { name: 'Eathomascript Font',  file: 'eathomascript.ttf' },
        { name: 'Damion-Regular',      file: 'damion-regular.ttf' },
